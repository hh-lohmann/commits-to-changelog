...
<!--Section content auto-generated by commits-to-changelog (https://npmjs.com/commits-to-changelog) at 2026-08-22T11:18:22.140Z -->
*Last 5 changes - see [CHANGELOG file](CHANGELOG.md) for full list and details*
  ...
  * (1.6.2) Feature: Write newest changelog entries also to README.md: display if no tag asscociated: only date
  * (1.6.2) fix: internal handling of EOF while searching for a section "Changelog" in README.md
  * (1.6.2) Feature: Write newest changelog entries also to README.md: fix: reject string containing more than a positive integer as value for "linesToReadme"
  * (1.6.2) Feature: Write newest changelog entries also to README.md: clarify: linesToReadme = 0 /  false / undefined leaves an existing section "Changelog" untouched
