...
<!--Section content auto-generated by commits-to-changelog (https://npmjs.com/commits-to-changelog) at 2026-09-01T10:58:35.595Z -->
*Last 5 changes - see [CHANGELOG file](CHANGELOG.md) for full list and details*

  * (2.3.0) Feature: Use commit date as group date if no tag is given (opt with setting to "current date")
  * (2.2.2) README: Clarify: Independent of special commit conventions
  * (2.2.2) README: Fix: Description of used date (commit date)
  * (2.2.1) Fix: Handling RegExp in settings, especially flags
  * (2.2.0) Deprecate: "Merged Branches" (intentional "no-ff" merges)
